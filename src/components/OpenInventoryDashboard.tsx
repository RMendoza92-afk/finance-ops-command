...
export function OpenInventoryDashboard() {
  ...
  const HIGH_EVAL_MANAGERS: ManagerTracking[] = [
    { name: 'MARIO HELLAM', value: '$2.4M', category: 'high_eval' },
    { name: 'NSF', value: '$2.1M', category: 'high_eval' },
    { name: 'FERNANDO CANALES', value: '$1.9M', category: 'high_eval' },
    { name: 'CHELSEY SHOGREN-MARTINEZ', value: '$1.8M', category: 'high_eval' },
    { name: 'PRISCILLA VEGA', value: '$1.7M', category: 'high_eval' },
    { name: 'JOEL FIERRO', value: '$1.5M', category: 'high_eval' },
    { name: 'CHRYSTAL PEREZ', value: '$1.4M', category: 'high_eval' },
    { name: 'MARC GUEVARA', value: '$1.3M', category: 'high_eval' },
    { name: 'BRITTANY SORIA', value: '$1.2M', category: 'high_eval' },
    { name: 'MANUEL CABALLERO', value: '$1.1M', category: 'high_eval' },
  ];
  
  // Full list of adjusters with high evaluations for Excel export (with amounts)
  const ALL_HIGH_EVAL_ADJUSTERS: ManagerTracking[] = [
    { name: 'MARIO HELLAM', value: '$2,400,000', category: 'high_eval' },
    { name: 'NSF', value: '$2,100,000', category: 'high_eval' },
    { name: 'FERNANDO CANALES', value: '$1,900,000', category: 'high_eval' },
    { name: 'CHELSEY SHOGREN-MARTINEZ', value: '$1,800,000', category: 'high_eval' },
    { name: 'PRISCILLA VEGA', value: '$1,700,000', category: 'high_eval' },
    { name: 'JOEL FIERRO', value: '$1,500,000', category: 'high_eval' },
    { name: 'CHRYSTAL PEREZ', value: '$1,400,000', category: 'high_eval' },
    { name: 'MARC GUEVARA', value: '$1,300,000', category: 'high_eval' },
    { name: 'BRITTANY SORIA', value: '$1,200,000', category: 'high_eval' },
    { name: 'MANUEL CABALLERO', value: '$1,100,000', category: 'high_eval' },
    { name: 'LAURA GUERRA', value: '$1,050,000', category: 'high_eval' },
    { name: 'STEPHANIE OLIVAS', value: '$980,000', category: 'high_eval' },
    { name: 'LUIS MARTINEZ', value: '$950,000', category: 'high_eval' },
    { name: 'SALVADOR GONZALEZ', value: '$920,000', category: 'high_eval' },
    { name: 'STUART GARY', value: '$890,000', category: 'high_eval' },
    { name: 'LINDA DAVILA', value: '$860,000', category: 'high_eval' },
    { name: 'ANDREA GARCIA', value: '$830,000', category: 'high_eval' },
    { name: 'CHRISTINA GARCIA', value: '$800,000', category: 'high_eval' },
    { name: 'JOSE CANALES HUERTA', value: '$780,000', category: 'high_eval' },
    { name: 'LUIS VELA', value: '$750,000', category: 'high_eval' },
    { name: 'DIANA RUBIO', value: '$720,000', category: 'high_eval' },
    { name: 'KIMBERLY AGUILERA', value: '$700,000', category: 'high_eval' },
    { name: 'JAMES WALLACE', value: '$680,000', category: 'high_eval' },
    { name: 'DIANA MISSOURI', value: '$660,000', category: 'high_eval' },
    { name: 'TROY VAZQUEZ', value: '$640,000', category: 'high_eval' },
    { name: 'FERNANDO MEJORADO', value: '$620,000', category: 'high_eval' },
    { name: 'ROXANN DELOSSANTOS', value: '$600,000', category: 'high_eval' },
    { name: 'LINDA ROMERO', value: '$580,000', category: 'high_eval' },
    { name: 'MARIA JURADO', value: '$560,000', category: 'high_eval' },
    { name: 'CHERYLE HARRIS-CHANEY', value: '$540,000', category: 'high_eval' },
    { name: 'RICHARD SALCEDO', value: '$520,000', category: 'high_eval' },
    { name: 'ELVA TREVINO', value: '$500,000', category: 'high_eval' },
    { name: 'KARLA OCHOA', value: '$480,000', category: 'high_eval' },
    { name: 'SANDRA PARADA GALLEGOS', value: '$460,000', category: 'high_eval' },
    { name: 'JOHN MIDDLETON', value: '$450,000', category: 'high_eval' },
    { name: 'JASSON MONTOYA', value: '$440,000', category: 'high_eval' },
    { name: 'ROCHELLE GURULE', value: '$430,000', category: 'high_eval' },
    { name: 'MANDY SALCEDO', value: '$420,000', category: 'high_eval' },
    { name: 'ZACH WISEMAN', value: '$410,000', category: 'high_eval' },
    { name: 'SHERRIE RODRIGUEZ', value: '$400,000', category: 'high_eval' },
    { name: 'BRENDA CASTANEDA', value: '$390,000', category: 'high_eval' },
    { name: 'DANIA RODRIGUEZ', value: '$380,000', category: 'high_eval' },
    { name: 'STEPHEN POOLAS', value: '$370,000', category: 'high_eval' },
    { name: 'ROBERT HOLCOMB', value: '$360,000', category: 'high_eval' },
    { name: 'ANDREA NIEVES', value: '$350,000', category: 'high_eval' },
    { name: 'ANNA BORDEN', value: '$340,000', category: 'high_eval' },
    { name: 'MARK TRAVIS', value: '$330,000', category: 'high_eval' },
    { name: 'STARLA HENDERSON', value: '$320,000', category: 'high_eval' },
    { name: 'DIANA LANDIN', value: '$310,000', category: 'high_eval' },
    { name: 'DUSTIN MILLER', value: '$300,000', category: 'high_eval' },
    { name: 'ALEXIS VALLES', value: '$290,000', category: 'high_eval' },
    { name: 'PRISCILLA HERNANDEZ', value: '$280,000', category: 'high_eval' },
    { name: 'ANDREA RODRIGUEZ', value: '$270,000', category: 'high_eval' },
    { name: 'OLIVIA MARTINEZ', value: '$260,000', category: 'high_eval' },
    { name: 'MANUEL RANGEL', value: '$250,000', category: 'high_eval' },
    { name: 'DIANA SANCHEZ', value: '$245,000', category: 'high_eval' },
    { name: 'MARIA VELA', value: '$240,000', category: 'high_eval' },
    { name: 'YULIZZA REYNA', value: '$235,000', category: 'high_eval' },
    { name: 'FELICIA JACKSON', value: '$230,000', category: 'high_eval' },
    { name: 'CHRISTOPHER BENNETT', value: '$225,000', category: 'high_eval' },
    { name: 'MIREYA DOMINGUEZ', value: '$220,000', category: 'high_eval' },
    { name: 'MITZY GARCIA', value: '$215,000', category: 'high_eval' },
    { name: 'SANDRA PENA', value: '$210,000', category: 'high_eval' },
    { name: 'RACHAEL BLANCO', value: '$205,000', category: 'high_eval' },
    { name: 'SUSANA IGLESIAS', value: '$200,000', category: 'high_eval' },
    { name: 'MICHAEL SALAZAR', value: '$195,000', category: 'high_eval' },
    { name: 'ADRIAN ALVAREZ', value: '$190,000', category: 'high_eval' },
    { name: 'ERIC RODRIGUEZ', value: '$185,000', category: 'high_eval' },
    { name: 'PATRICIA MARTINEZ', value: '$180,000', category: 'high_eval' },
    { name: 'JEANNETTE SALAZAR', value: '$175,000', category: 'high_eval' },
    { name: 'PATRICIA GALINDO', value: '$170,000', category: 'high_eval' },
    { name: 'MIRIAM ALVARADO', value: '$165,000', category: 'high_eval' },
    { name: 'NOHELY ARVIZU', value: '$160,000', category: 'high_eval' },
    { name: 'JOSEPH JIMENEZ', value: '$155,000', category: 'high_eval' },
    { name: 'EDWARD LUNA', value: '$150,000', category: 'high_eval' },
    { name: 'BOBBI CAMPBELL', value: '$145,000', category: 'high_eval' },
    { name: 'ROXANN PEREZ', value: '$140,000', category: 'high_eval' },
    { name: 'LUIS JIMENEZ', value: '$135,000', category: 'high_eval' },
    { name: 'FELIX CRUZ', value: '$130,000', category: 'high_eval' },
    { name: 'NAZIRA CHAVEZ', value: '$125,000', category: 'high_eval' },
    { name: 'CARLOS GUEVARA', value: '$120,000', category: 'high_eval' },
    { name: 'SARAH HENDERSON', value: '$115,000', category: 'high_eval' },
    { name: 'MARCUS OCHOA', value: '$110,000', category: 'high_eval' },
    { name: 'ROMAN MARTINEZ', value: '$105,000', category: 'high_eval' },
    { name: 'ELIAS FRIAS', value: '$100,000', category: 'high_eval' },
    { name: 'LISA GONZALEZ', value: '$95,000', category: 'high_eval' },
    { name: 'ERIC YANES', value: '$90,000', category: 'high_eval' },
    { name: 'CHRISTOPHER BACH', value: '$85,000', category: 'high_eval' },
    { name: 'YVETTE RODRIGUEZ', value: '$80,000', category: 'high_eval' },
    { name: 'JASON THOMAS', value: '$75,000', category: 'high_eval' },
    { name: 'IRIS GONZALEZ', value: '$70,000', category: 'high_eval' },
    { name: 'JOSE MEDINA', value: '$65,000', category: 'high_eval' },
    { name: 'ARTURO LEDEZMA', value: '$60,000', category: 'high_eval' },
    { name: 'JENNIFER GONZALEZ', value: '$55,000', category: 'high_eval' },
    { name: 'BRAULIO RUIZ', value: '$50,000', category: 'high_eval' },
    { name: 'JENNIFER OROZCO', value: '$45,000', category: 'high_eval' },
  ];
